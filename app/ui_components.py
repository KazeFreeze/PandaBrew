...
# Define a consistent font for the terminal theme [build]
...
class UIComponents:
    ...
    def _configure_styles(self) -> None:
        ...
        style.map(
            ...
            foreground=[("selected", "white"), ("!selected", style.colors.get("info"))],
            background=[("selected", style.colors.get("bg")), ("!selected", "#404040")],
        )
    ...
    def _create_filter_settings(
        ...
        exclude_text = ScrolledText(
            exclude_frame, height=4, font=TERMINAL_FONT, autohide=True, bootstyle="info"
        )
        ...
        ttkb.Label(include_frame, text="Include Patterns (Overrides Exclude)").pack(
            anchor="w", pady=(0, 5)
        )
        include_text = ScrolledText(
            include_frame, height=4, font=TERMINAL_FONT, autohide=True, bootstyle="info"
        )
    ...
    def create_path_selection(
        ...
        ttkb.Label(path_frame, text="Source:").grid(
        ...
        ttkb.Label(path_frame, text="Output:").grid(
        ...
        ttkb.Button(
            ...
            bootstyle="info-outline",
        ).grid(row=1, column=2, padx=(10, 0), pady=(5, 0))
    ...
    def create_options_section(self, parent: ttkb.Frame) -> None:
        ...
        ttkb.Label(
            output_options_frame, text="Output Options:", font=TERMINAL_FONT_BOLD
        ).pack(anchor="w")
