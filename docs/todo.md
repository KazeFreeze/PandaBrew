...
- [x] fix opening a new tab with same directory shouldnt resolve to
      already opened directory
- [ ] fix tab scrolling to always show keybinds and branding
- [x] fix selected number of items bug (it's offset by +1)
- [x] add option to extract everything in view but only include the code of those
      checked
